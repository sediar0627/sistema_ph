<div>
    <div>
        <div class="flex flex-col lg:flex-row items-center justify-center w-full pt-4">
            <p class="font-medium text-sm text-gray-700 md:mr-5">NOMBRE</p>
            <input wire:model.lazy="piscina.nombre" type="text" class="text-black placeholder-gray-600 w-40 px-4 py-2.5 my-4 md:m-0 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-2 ring-offset-current ring-gray-500">
            <p class="font-medium text-sm text-gray-700 md:mr-5 md:ml-5">LITROS DE LA PISCINA</p>
            <input wire:model.lazy="piscina.litros" type="text" class="text-black placeholder-gray-600 w-32 px-4 py-2.5 my-4 md:m-0 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-2 ring-offset-current ring-gray-500">
            <button wire:click="GuardarPiscina" class="md:ml-5 w-64 px-4 py-2.5 rounded-xl focus:outline-none bg-indigo-500 text-white hover:bg-indigo-600">
                GUARDAR PISCINA
            ...
            <button wire:click="LimpiarCampos" class="md:ml-5 md:mt-0 mt-2 w-64 px-4 py-2.5 rounded-xl focus:outline-none bg-red-400 text-white hover:bg-red-500">
                LIMPIAR CAMPOS
